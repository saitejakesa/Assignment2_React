                ...
                <div className="card shadow mb-4">
                  ...
                  <div className="card-body">
                    <div className="text-center">
                      <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: "25rem;"}} src="/home/saiteja/GitClonedRepos/reactapks/assignmentadminpage/images/undraw_posting_photo.svg" alt="..." />
                    </div>
